...
CALL add_column_if_missing('loan_requests', 'guest_gcash_name', '`guest_gcash_name` VARCHAR(150) DEFAULT NULL AFTER `guest_borrower_name`');
CALL add_column_if_missing('loan_requests', 'guest_gcash_number', '`guest_gcash_number` VARCHAR(50) DEFAULT NULL AFTER `guest_gcash_name`');
CALL add_column_if_missing('loan_requests', 'disbursement_reference_number', '`disbursement_reference_number` VARCHAR(100) DEFAULT NULL AFTER `guest_gcash_number`');
...
CALL add_column_if_missing('loans', 'guest_gcash_name', '`guest_gcash_name` VARCHAR(150) DEFAULT NULL AFTER `guest_borrower_name`');
CALL add_column_if_missing('loans', 'guest_gcash_number', '`guest_gcash_number` VARCHAR(50) DEFAULT NULL AFTER `guest_gcash_name`');
CALL add_column_if_missing('loans', 'disbursement_reference_number', '`disbursement_reference_number` VARCHAR(100) DEFAULT NULL AFTER `guest_gcash_number`');
